  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p class="lead">Você acabou de adquirir um produto de ponta, e para finalizar esta compra tão importante, <strong>clique no link abaixo</strong> para ser redirecionado até a página do seu banco.</p>
        <hr>
        <p>
          Dúvidas? <a href="">Fale conosco</a>
        </p>
        <p class="lead">
          <a class="btn btn-primary btn-sm" style="color: #fff;" href="<?php echo $link_debito; ?>" id="link-boleto" name="link-boleto" role="button">Acessar o banco</a>
        </p>

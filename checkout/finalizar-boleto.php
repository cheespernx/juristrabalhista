  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 text-center">
        ...
        <p class="lead">Você acabou de adquirir um produto de ponta, e para finalizar esta compra tão importante, <strong>clique no link abaixo</strong> para receber o seu Boleto.</p>
        <hr>
        <p>
          Dúvidas? <a href="">Fale conosco</a>
        </p>
        <p class="lead">
          <a class="btn btn-primary btn-block" style="color: #fff;" onclick="window.open('<?php echo $link_boleto;?>','page','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=500,height=600');" id="link-boleto" name="link-boleto" role="button">Gerar Boleto</a>
        </p>
      </div>
      <div class="footer fixed-bottom text-center">
        <p>
          <a class="link" href="https://topprimesegurosesaude.com.br" id="link-boleto" name="link-boleto" role="button">Voltar ao Site</a>
        </p>
      </div>
    </div>
  </div>

  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#"><img src="../assets/img/logo-branco.png" width="150px"></a>
      </div>
    ...
    <div class="page-header lock-page header-filter" style="background-image: url('../assets/img/lock.jpg')">
      ...
      <div class="container">
        <div class="row">
          ...
          <form class="form" method="POST" action="../lock.php">
            <?php if(isset($_SESSION['erro_login'])){?>
              ...
              <div class="card card-profile text-center card-hidden">
                ...
                <div class="card-footer justify-content-center">
                  <button class="btn btn-rose btn-round">Desbloquear</button>
                </div>
              </div>
            </form>
          </div>
      ...
      <footer class="footer">
        <div class="container">
          <div class="copyright float-center">
            ...
            <a href="https://juristrabalhista.com" target="_blank">Juris<b>Trabalhista</b> | Desenvolvido por <a href="https://nexusnx.com">Nexus NX</a>
          </div>
        </div>
      </footer>
    </div>
